    ...
    <tr>
        ...
        foreach ($alumnos as $row) {
            echo "<tr><td>" . $row['ci'] . "</td><td>" . $row['nombres'] . "</td><td>" . $row['apellidos'] . "</td><td>" . $row['direccion'] .
             ...
             <td><a href='seccionEncargado.php?mode=edit&section=addEditAlumno&idAlumno=" . $row['ci'] . "'><img height='30' width='30' src='./../img/editicon.jpg'></a></td><td><a href=# onclick=borrar('./../controllers/DeleteObj.php?id=".$row['ci']."')><img height='30' width='30' src='./../img/deleteicon.jpg'></a></td></tr>";
        }
